...
def _extract_via_ai_free_form(
    ...
    try:
        ...
        scalar_prompt = (
            ...
            "Rules:\n"
            "  • Field names: translate to English and normalise to snake_case.\n"
            "    If the document is not in English, translate the label to English first.\n"
            "    e.g. 'Rechnungsnummer' → 'invoice_number', 'Date de livraison' → 'delivery_date',\n"
            "         'Importo totale' → 'total_amount', 'Bedrag' → 'amount', 'Datum' → 'date'.\n"
            "    Use standard English trade document terminology where possible.\n"
        ...
        table_prompt = (
            ...
            "  Column names: translate to English and use Title Case.\n"
            "    e.g. 'Menge' → 'Quantity', 'Beschreibung' → 'Description', 'Preis' → 'Price',\n"
            "         'Référence' → 'Reference', 'Désignation' → 'Description', 'Quantité' → 'Quantity'.\n"
    ...
    try:
        ...
        if not target_fields:
            ...
            prompt = (
                ...
                "    If the document is not in English, translate the label to English first.\n"
                "    e.g. 'Rechnungsnummer' → 'invoice_number', 'Date de livraison' → 'delivery_date',\n"
                "         'Importo totale' → 'total_amount', 'Bedrag' → 'amount'.\n"
                "    Use standard English trade document terminology where possible.\n\n"
